...
class TestCoreFunctionality:
    ...
    def test_open_constructor(self, driver, constructor_page, auth_page):
    ...
    def test_open_list_orders(self, driver, constructor_page, order_feed_page):
        constructor_page.main_page_loading_wait() # ждем исчезновения оверлея
    ...
    def test_popup_details_ingredient(self, driver, constructor_page):
        constructor_page.main_page_loading_wait() # ждем исчезновения оверлея
    ...
    def test_close_popup_details_ingredient(self, driver, constructor_page):
        constructor_page.main_page_loading_wait() # ждем исчезновения оверлея
        constructor_page.click_on_ingredient_bun() # нажимаем на ингредиент булка
        constructor_page.wait_for_header_popup() # ждем появления заголовка на всплываюшем окне
    ...
    def test_increase_the_ingredient_counter(self, driver, constructor_page):
        constructor_page.main_page_loading_wait() # ждем исчезновения оверлея
